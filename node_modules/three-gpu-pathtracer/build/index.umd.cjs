...
`;
	...
	class QuiltViewUtility {
		...
		constructor() {
			...
			this.viewCount = 48;
			this.quiltDimensions = new three.Vector2( 8, 6 );
			this.viewCone = 35 * three.MathUtils.DEG2RAD;
			this.viewFoV = 14 * three.MathUtils.DEG2RAD;
		...
		getCameraViewInfo( i, target = {} ) {
			...
			// initialize defaults
			target.subframe = target.subframe || new three.Vector4();
			target.offsetDirection = target.offsetDirection || new three.Vector3();
			target.projectionMatrix	= target.projectionMatrix || new three.Matrix4();
...
`;
	...
	class PrecisionDetector {
		...
		detect() {
			...
			const quad = new Pass_js.FullScreenQuad( material );
	...
	exports.CompatibilityDetector = CompatibilityDetector;
	...
	exports.GradientMapMaterial = GradientMapMaterial;
	exports.GraphMaterial = GraphMaterial;
