...
declare module Jolt {
    ...
    class PathConstraintPathJS extends PathConstraintPath {
        constructor();
        GetPathMaxFraction(): number;
        GetClosestPoint(inPosition: Vec3, inFractionHint: number): number;
        GetPointOnPath(inFraction: number, outPathPosition: Vec3, outPathTangent: Vec3, outPathNormal: Vec3, outPathBinormal: Vec3): void;
    }
    ...
    class SoftBodyContactListenerJS {
        constructor();
        OnSoftBodyContactValidate(inSoftBody: Body, inOtherBody: Body, ioSettings: SoftBodyContactSettings): number;
        OnSoftBodyContactAdded(inSoftBody: Body, inManifold: SoftBodyManifold): void;
    }
    ...
    class CharacterContactListenerJS {
        ...
        OnContactAdded(inCharacter: CharacterVirtual, inBodyID2: BodyID, inSubShapeID2: SubShapeID, inContactPosition: RVec3, inContactNormal: Vec3, ioSettings: CharacterContactSettings): void;
        OnContactSolve(inCharacter: CharacterVirtual, inBodyID2: BodyID, inSubShapeID2: SubShapeID, inContactPosition: RVec3, inContactNormal: Vec3, inContactVelocity: Vec3, inContactMaterial: PhysicsMaterial, inCharacterVelocity: Vec3, ioNewCharacterVelocity: Vec3): void;
    }
